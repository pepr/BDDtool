...
Scenario xyz: titulek scénáře začíná za dvojtečkou
  Dáno: soubor s definicemi scénářů
  Když: za slovem "scénář"   

Scénář 1: analytické popisy se oddělují do samostatných souborů
...
Scénář 2: požadavek bez scénářů nevygeneruje žádné testy
  Dáno: existující soubor.feature
  Když: obsah souboru nedefinuje žádný scénář
   Pak: nebude vygenerován žádný spustitelný test
     a: celá definice se do vygenerovaného .h souboru vloží jako komentář
